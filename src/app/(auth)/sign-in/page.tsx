    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10">
      ...
      <div className="relative grid w-full max-w-[66rem] gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        <section className="glass-panel hidden rounded-[32px] p-8 lg:block">
          ...
          <h1 className="mt-3 text-4xl font-bold tracking-[-0.04em] text-white">Enter a structured workspace with visible signal and controlled access.</h1>
          ...
          <div className="mt-8 rounded-[24px] border border-[rgba(49,196,141,0.18)] bg-[rgba(49,196,141,0.08)] p-4">
            <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[var(--app-text-muted)]">Live posture</p>
            <p className="mt-2 font-mono text-sm leading-7 text-[#98f0c6]">
              AUTH: READY
              <br />
              AI CONTEXT: GUARDED
              <br />
              SESSION ENTRY: VERIFIED
            </p>
          </div>
        </section>
