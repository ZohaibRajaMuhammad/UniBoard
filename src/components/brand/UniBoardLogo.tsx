...
export function UniBoardLogo({
  ...
  return (
    <div className={cn("flex items-center gap-3", className)}>
      <div
        className={cn(
          "relative shrink-0 overflow-hidden rounded-[20px] border border-[color:var(--app-line-strong)] bg-[linear-gradient(145deg,rgba(49,92,243,0.18),rgba(112,88,214,0.12),rgba(255,255,255,0.7))] shadow-[0_14px_40px_rgba(49,92,243,0.18)] backdrop-blur-sm",
          markClassName
        )}
      ...
      >
        <svg viewBox="0 0 64 64" className="h-full w-full" aria-hidden="true" focusable="false">
          <defs>
            <linearGradient id="uniboard-primary" x1="8" y1="8" x2="56" y2="56" gradientUnits="userSpaceOnUse">
              <stop offset="0" stopColor="#80A1FF" />
              <stop offset="0.55" stopColor="#315CF3" />
              <stop offset="1" stopColor="#7058D6" />
            </linearGradient>
            <linearGradient id="uniboard-surface" x1="10" y1="10" x2="54" y2="54" gradientUnits="userSpaceOnUse">
              <stop offset="0" stopColor="rgba(255,255,255,0.96)" />
              <stop offset="1" stopColor="rgba(255,255,255,0.82)" />
            </linearGradient>
          </defs>

          <rect x="6" y="6" width="52" height="52" rx="18" fill="url(#uniboard-surface)" opacity="0.88" />
          <path
            ...
            fill="url(#uniboard-primary)"
          />
          <circle cx="19" cy="19" r="3" fill="#315CF3" />
          <circle cx="49" cy="45" r="3" fill="#7058D6" />
          <path d="M15.5 32H24" stroke="#315CF3" strokeWidth="2.5" strokeLinecap="round" opacity="0.65" />
          <path d="M40 15.5H48.5" stroke="#80A1FF" strokeWidth="2.5" strokeLinecap="round" opacity="0.72" />
        </svg>
      </div>
