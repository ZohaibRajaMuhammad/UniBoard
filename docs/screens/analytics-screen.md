...
Source prototypes: uniboard-ai.html

## 1. Screen Overview
- Screen purpose: Expose room or user activity analytics such as heatmaps, post mix, and engagement trends.
- Business goal: Help students and instructors identify activity patterns and optimize participation.
- User goal: Understand engagement intensity, topic distribution, and actionable trends.
- Primary actions:
- Review charts
- Inspect AI risk card
- Compare trends over time
- Secondary actions:
- Navigate back to room
- Cross-reference analytics with deadlines
- Use keyboard shortcuts

## 2. UI Layout Architecture
- Structural layout:
- Wide page layout up to 1100px
- Chart cards arranged in responsive grid
- AI prediction card positioned near the top of the analytical narrative
...
|---|---|---|---|---|---|---|---|---|---|---|
| analytics-chart-cards | Chart cards | Visualization cards | Desktop, tablet, mobile | Show trends and distributions | Read, possibly hover | loading, loaded, no-data | Authenticated with analytics rights | analytics datasets | Date range and scope | Tooltips needed for exact values |
| analytics-risk-card | AI deadline risk card | AI insight module | Desktop, tablet, mobile | Expose predicted assignment risk | Review | loading, loaded, insufficient-signal | Authenticated and AI enabled | risk data | Confidence threshold | Use calibrated, not pseudo-precise percentages |
| analytics-heatmap | Heatmap grid | Visualization | Desktop, tablet, mobile | Show activity intensity | Hover/tap for tooltip | loading, loaded | Authenticated | heatmap bins | Time-zone normalized | Present in AI prototype support functions |
...
## 5. State Management
- Initial state: Chart loading, chart rendered, stale cached analytics, no-data period, analytics service failure.
...
## 6. Business Logic
- Screen logic:
- Time-bucketed metrics depend on normalized timezone handling
- Instructor vs student sees different comparative baselines
- Risk cards combine academic engagement and deadline metadata
...
## 8. Edge Cases
- Sparse data causing misleading charts
- Late-arriving events changing historical counts
- Permission denial for cohort-wide comparison
